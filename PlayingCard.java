...
public class PlayingCard {
    ...
    public static final String[] SUIT={"Joker", "Clubs", "Diamonds", "Hearts", "Spades"};
	...
	public String toString() {
		...
		text=NUMBERS[number]+" of "+SUIT[this.suit];
		}
		/*
		switch(this.number){
		case ACE: text="One of "; break;
		case TWO: text="Two of ";  break;
		case THREE: text="Three of ";  break;
		case FOUR: text="Four of ";  break;
		case FIVE: text="Five of ";  break;
		case SIX: text="Six of ";  break;
		case SEVEN: text="Seven of ";  break;
		case EIGHT: text="Eight of ";  break;
		case NINE: text="";  break;
		case TEN: text="";  break;
		case JACK: text="";  break;
		case QUEEN: text="";  break;
		case KING: text="";  break;
		case JOKER: text="";  break;
		}
		switch(this.suit){
		case CLUBS: text+="Clubs";  break;
		case DIAMONDS: text+="Diamonds";  break;
		case HEARTS: text+="Hearts";  break;
		case SPADES: text+="Spades";  break;
		}
		*/
